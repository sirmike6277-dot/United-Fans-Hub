export function PredictionHistorySkeleton() {
  return (
    <div className="rounded-card border border-white/10 bg-bg-surface p-4 sm:p-5" aria-hidden="true">
      ...
      <div className="mt-3 h-3 w-36 animate-pulse rounded bg-white/5" />
    </div>
  );
}
