    ...
    <div className="flex w-full flex-col gap-8" aria-hidden="true">
      ...
      <div className="flex flex-col gap-5">
        <div className="flex flex-col gap-1.5">
          ...
          <div className="h-11 w-full animate-pulse rounded-control bg-ink/5" />
        </div>
        <div className="flex flex-col gap-1.5">
          <div className="h-3 w-20 animate-pulse rounded bg-ink/10" />
          <div className="h-11 w-full animate-pulse rounded-control bg-ink/5" />
        </div>
        <div className="h-14 w-full animate-pulse rounded-control bg-ink/10" />
      </div>

      <div className="h-4 w-48 max-w-full animate-pulse self-center rounded bg-ink/5" />
    </div>
  );
}
