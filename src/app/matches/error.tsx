...
export default function MatchesError({
  ...
  return (
    <>
      {/* Wordmark, not Brand — see community/error.tsx, notifications/error.tsx,
          messages/error.tsx, members/error.tsx: Brand's ClubEmblem reads the
          filesystem and can only run server-side. */}
