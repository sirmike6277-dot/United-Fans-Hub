    ...
    <main className="flex-1 bg-bg-void pb-20" aria-hidden="true">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="-mt-12 flex flex-col gap-4 sm:-mt-16 sm:flex-row sm:items-end">
          ...
          <div className="flex flex-1 flex-wrap items-center justify-between gap-3 pb-2">
            <div className="min-w-0 space-y-2">
              <div className="h-7 w-40 max-w-full animate-pulse rounded bg-ink/10" />
              <div className="h-4 w-24 max-w-full animate-pulse rounded bg-ink/5" />
            </div>
            <div className="h-9 w-24 shrink-0 animate-pulse rounded-control bg-ink/5" />
          </div>
        </div>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <div className="h-6 w-24 animate-pulse rounded-full bg-ink/5" />
        </div>

        <div className="mt-6 h-2.5 max-w-md animate-pulse rounded-full bg-ink/5" />
        ...
        <div className="mt-10 flex gap-4 border-b border-ink/10 pb-2.5">
          <div className="h-4 w-16 animate-pulse rounded bg-ink/10" />
          <div className="h-4 w-16 animate-pulse rounded bg-ink/5" />
