  ...
  return (
    <div className="flex h-full flex-col" aria-hidden="true">
      ...
      <div className="flex-1 space-y-3 overflow-hidden px-4 py-4">
        <div className="ml-auto h-10 w-2/5 animate-pulse rounded-control bg-white/10" />
        <div className="h-10 w-1/2 animate-pulse rounded-control bg-white/5" />
        <div className="ml-auto h-10 w-1/3 animate-pulse rounded-control bg-white/10" />
        <div className="h-10 w-3/5 animate-pulse rounded-control bg-white/5" />
      </div>

      <div className="h-[68px] shrink-0 border-t border-white/10" />
    </div>
  );
}
