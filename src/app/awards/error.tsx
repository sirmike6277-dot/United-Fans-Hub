...
export default function AwardsError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => {
    console.error(error);
  }, [error]);
    ...
    <>
      ...
      <main className="flex flex-1 items-center justify-center bg-bg-void px-4 py-24">
        <div className="max-w-sm text-center">
          ...
          <p className="mt-2 text-sm text-text-muted">We couldn&apos;t load Awards. Please try again.</p>
